			...
			<nav class="navbar navbar-expand-lg navbar-light bg-black text-white">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <?php if ($this->session->userdata('logged_in')) { ?>
                     <li class="nav-item">
                        <a class="nav-link text-white text-uppercase <?php if($page == 'home'){ echo ' active';}?>" href="<?php echo base_url(); ?>">Dashboard</a>
                     </li>
                  <?php } ?>
                     <li class="nav-item">
                  ...
                  <?php if (!$this->session->userdata('logged_in')) { ?>
							<li class="nav-item">
								<a class="nav-link text-white text-uppercase <?php if($page == 'aanvragen'){ echo 'active';} ?>" href="<?php echo base_url(); ?>aanvragen">Aanvragen</a>
							</li>
						<?php } ?>
						</ul>
						<ul class="navbar-nav">
